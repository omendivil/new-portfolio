  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full items-center justify-center">
        <div className="w-full rounded-2xl border border-white/[0.05] bg-[rgba(8,8,14,0.6)] px-6 py-6 backdrop-blur-[30px] sm:px-7" style={{ maxWidth: "min(960px, 92vw)", boxShadow: "0 40px 120px -20px rgba(0,0,0,0.7)" }}>
